...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_PersonInfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::PersonInfo, grouptype_),
};
...
const char descriptor_table_protodef_PersonInfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\003(\0132\r.WeaponStatus\"\343\001\n\nPersonInfo\022\n\n\002id\030"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_PersonInfo_2eproto = {
  false, false, descriptor_table_protodef_PersonInfo_2eproto, "PersonInfo.proto", 616,
...
PersonInfo::PersonInfo(const PersonInfo& from)
  ...
  grouptype_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_grouptype().empty()) {
    grouptype_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_grouptype(), 
      GetArena());
  }
...
void PersonInfo::SharedDtor() {
  ...
  grouptype_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    ...
    switch (tag >> 3) {
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 82)) {
          auto str = _internal_mutable_grouptype();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "PersonInfo.groupType"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* PersonInfo::_InternalSerialize(
  ...
  // string groupType = 10;
  if (this->grouptype().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_grouptype().data(), static_cast<int>(this->_internal_grouptype().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "PersonInfo.groupType");
    target = stream->WriteStringMaybeAliased(
        10, this->_internal_grouptype(), target);
  }
...
void PersonInfo::InternalSwap(PersonInfo* other) {
  ...
  grouptype_.Swap(&other->grouptype_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PersonInfo, setdeath_)
