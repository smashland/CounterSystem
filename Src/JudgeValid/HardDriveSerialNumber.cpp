...
int CHardDriveSerialNumber::ReadPhysicalDriveInNTWithAdminRights (void)
{
   int iDone = FALSE;
   int iDrive = 0;
...
int CHardDriveSerialNumber::ReadPhysicalDriveInNTUsingSmart (void)
{
   int iDone = FALSE;
   int iDrive = 0;
...
char * CHardDriveSerialNumber::flipAndCodeBytes ( int iPos, int iFlip, const char * pcszStr, char * pcszBuf)
{
   int iI;
   int iJ = 0;
   int iK = 0;
...
int CHardDriveSerialNumber::ReadPhysicalDriveInNTWithZeroRights (void)
{
   int iDone = FALSE;
   int iDrive = 0;
...
BOOL CHardDriveSerialNumber::DoIDENTIFY (HANDLE hPhysicalDriveIOCTL, PSENDCMDINPARAMS pSCIP,
...
int CHardDriveSerialNumber::ReadIdeDriveAsScsiDriveInNT (void)
{
   int iDone = FALSE;
   int iController = 0;
...
void CHardDriveSerialNumber::PrintIdeInfo (int iDrive, DWORD dwDiskData [256])
{
...
long CHardDriveSerialNumber::getHardDriveComputerID ()
{
   int iDone = FALSE;
   // char string [1024];
   __int64 i64Id = 0;
...
QString CHardDriveSerialNumber::GetSerialNo()
{
    ...
    return QString(m_cszHardDriveSerialNumber);
}

char *CHardDriveSerialNumber::ConvertToString (DWORD dwDiskData [256],
               int iFirstIndex,
               int iLastIndex,
               char* pcszBuf)
{
...
int CHardDriveSerialNumber::GetErrorMessage(TCHAR* tszErrorMessage)
{
...
CHardDriveSerialNumber::CHardDriveSerialNumber()
{
    SecureZeroMemory(m_cszErrorMessage,sizeof(m_cszErrorMessage));
